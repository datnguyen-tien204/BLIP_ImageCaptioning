...
from data.uit_viic_dataset import uit_viic_dataset_train, uit_viic_dataset_val
...
def create_dataset(config, min_scale=0.5):
    ...
    elif dataset=='uit_viic':
        train_dataset = uit_viic_dataset_train(transform_train, config['image_root'], config['ann_root'])
        val_dataset = uit_viic_dataset_val(transform_test, config['image_root'], config['ann_root'], 'val')
        test_dataset = uit_viic_dataset_val(transform_test, config['image_root'], config['ann_root'], 'test')
        return train_dataset, val_dataset, test_dataset
